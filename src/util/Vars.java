...
public class Vars implements Serializable {
   ...
   public static int numberOfRestarts = 0;
    ...
    /**
     * Whether the length of the threshold list of the acceptance mechanism can
     * be updated *
     */
    public final static boolean enableUpdateListLength = false;
    ...
    /**
     * Whether to use overall best solution found/visited after
     * re-initialisations *
     */
    ...
    /**
     * The upper bound for the tabu duration (d) in the heuristic selection
     * mechanism *
     */
    public static int tabuDurationUB;
    /**
     * The tabu duration (d) multiplier to calculate the tabu duration upper
     * bound in the heuristic selection mechanism *
     */
    ...
    /**
     * Whether the phase length is calculated based on speed of the non-tabu
     * heuristics *
     */
    ...
    /**
     * Whether time based information is used to calculate heuristics' selection
     * probabilities *
     */
    ...
    /**
     * A constant value used to calculate the iteration limit (K) for increasing
     * the threshold level *
     */
    ...
    /**
     * Calculate new phase length referring to a number of iterations to capture
