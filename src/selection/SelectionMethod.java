 ...
 * be extended to implement new selection mechanisms.
 */
public abstract class SelectionMethod implements Serializable {
    ...
    /**
     * Get the probability list involving first heuristics' selection
     * probabilities in the relay hybridisation
     *
     * @return	the probability list involving first heuristics' selection
     * probabilities in the relay hybridisation in a string
     */
    ...
    /**
     * Update the level of change values (heuristics' parameter values) for a
     * given heuristic
     *
    ...
    public void updateLevelOfChange(LevelOfChangeType lcType, HeuristicClassType hClassType, int heurIndex) {
        System.out.println("@updateLevelOfChange => This method is not present for this object!");
        System.exit(1);
    }
    ...
    public double[] getLevelOfChangeList() {
        System.out.println("@getLevelOfChangeList => This method is not present for this object!");
        System.exit(1);
        return null;
    }

    /**
     * Get the level of change list for the heuristics' parameter values in a
     * string
     *
     * @return the heuristics' parameter values in a string
     */
    public String getLevelOfChangeListAsString() {
        System.out.println("@printLevelOfChangeList => This method is not present for this object!");
        System.exit(1);
        return null;
    }
     ...
     * @param fitnessBefore	quality (fitness) of the solution before applying
     * the corresponding heuristic
     * @param fitnessAfter	quality (fitness) of the solution after applying the
     * corresponding heuristic
     * @param bestFitness	current best fitness value
     * @param heursiticStartTime	execution starting time of the corresponding
     * heuristic
     * @param heursiticEndTime	execution ending time of the corresponding
     * heuristic
     * @param learningMultRateList	an array of units showing the speed of the
     * heuristics with respect to the fastest non-tabu heuristic
     * @param currPerformance	current performance status of the heuristics
    ...
    public void updateSelectionElements(int heuristicIndex, HeuristicClassType heuristicClassType,
        ...
        System.out.println("@updateSelectionElements => This method is not present for this object!");
        System.exit(1);
    }
     ...
     * @param currPerformance	current performance status of the heuristics
     * (during current phase)
     * @param prevPerformance	preceding performance status of the heuristics
    ...
    public void update(double[] performanceRate, double[] worseningRate, double[] execTimeList,
        ...
        System.out.println("@update (STD) => This method is not present for this object!");
        System.exit(1);
    }
     ...
     *
     * @param heuristicIndex	index of the first heuristic applied by the relay
     * hybridisation
     * @param secondHeurIndex	index of the second heuristic applied by the relay
     * hybridisation
     * @param updateType	update type (0: worsening move, 1: new best move, 2:
     * improving move)
    ...
    public void updateProbListForRelay(int heuristicIndex, int secondHeurIndex, int updateType, double[] learningRateMultList) {
        System.out.println("@updateProbListForRelay (STD) => This method is not present for this object!");
        System.exit(1);
    }

    /**
     * Select an improving heuristic (used for choosing the second heuristic in
     * the relay hybridisation)
     *
     * @param heurClassTypeList	heuristics class types (based on introduced
     * generic heuristic types)
     * @return	index of the selected heuristic
     */
    public int selectAnImprovementHeuristic(HeuristicClassType[] heurClassTypeList) {
        System.out.println("@selectAnImprovementHeuristic => This method is not present for this object!");
        System.exit(1);
        return -1;
    }
}
