...
/**
 * This class is used to monitor the performance of the heuristics in terms of
 * improvement capabilities and speed.
 */
public class PerformanceElements implements Serializable {
    ...
    /**
     * An array of values showing the number of moves performed by each
     * heuristic *
     */
    protected long[] numberOfMoves;

    /**
     * An array of values showing the number of new best solutions found by each
     * heuristic *
     */
    protected long[] numberOfImprovingBestMoves;

    /**
     * An array of values showing the number of improvement solutions found by
     * each heuristic *
     */
    protected long[] numberOfImprovingMoves;

    /**
     * An array of values showing the number of equal quality solutions found by
     * each heuristic *
     */
    protected long[] numberOfEqualMoves;

    /**
     * An array of values showing the number of worsening solutions found by
     * each heuristic *
     */
    ...
    /**
     * An array of values showing the amount of fitness improvement provided by
     * each heuristic *
     */
    protected double[] totalHeurImprovement;

    /**
     * An array of values showing the amount of fitness worsening caused by each
     * heuristic *
     */
    ...
    /**
     * An array of values showing the number of moves over time by each
     * heuristic *
     */
     ...
     * @param fitnessBefore	quality of the solution before the corresponding
     * heuristic is applied
     * @param fitnessAfter	quality of the solution after the corresponding
     * heuristic is applied
     ...
     * Get number of moves performed by each heuristic
     *
     * @return	an array where each element refers to the number of moves
     * performed by one heuristic
     */
     ...
     *
     * @return	an array where each element refers to the number of new best
     * solutions found by one heuristic
     */
     ...
     *
     * @return	an array where each element refers to the number of improving
     * solutions found by one heuristic
     */
     ...
     *
     * @return	an array where each element refers to the number of equal quality
     * solutions found by one heuristic
     */
     ...
     *
     * @return	an array where each element refers to the number of worsening
     * solutions found by one heuristic
     */
     ...
     *
     * @return	an array where each element refers to the spent execution time by
     * one heuristic
     */
     ...
     *
     * @return	an array where each element refers to the total fitness
     * improvement provided by one heuristic
     */
     ...
     *
     * @return	an array where each element refers to the total fitness worsening
     * caused by one heuristic
     */
     ...
     *
     * @return	the number of new best solutions found the by the relay
     * hybridisation
     */
     ...
     *
     * @param FCNumberOfImprovingBestMoves	the number of new best solutions
     * found the by the relay hybridisation
     */
     ...
     *
     * @return	an array of the lowest and highest fitness improvement provided
     * by each heuristic
     */
     ...
     *
     * @return	an array of the number of improving solutions found over time by
     * each heuristic
     */
